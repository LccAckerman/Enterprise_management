...
namespace PWMS.DataClass
{
    ...
    class MyMeans
    {
        ...
        public static string M_str_sqlcon = "Data Source=DESKTOP-DR8SAH5;Database=db_PWMS;User id=xzwyb;PWD=xzwyb";
        //public static string M_str_sqlcon = "Data Source=XIAOKE\\XIAOKE;Initial Catalog=db_PWMS;Integrated Security=True";
